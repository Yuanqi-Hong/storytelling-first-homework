...
(function () {
  ...
  var yPositionScale = d3.scalePoint().domain(['dog', 'cow', 'cat']).range([0, height]).padding(0.25);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', 7).attr('cx', function (d) {
...
//# sourceMappingURL=/11-chart.24fe642b.map