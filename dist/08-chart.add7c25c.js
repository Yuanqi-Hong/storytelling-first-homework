...
(function () {
  ...
  var pointScale = d3.scalePoint().domain(['Panda', 'Cat', 'Horse', 'Pig']).range([0, width - 100]);

  var radiusScale = d3.scaleSqrt().domain([0, 1000]).range([0, 50]);

  // Set your attributes here
  svg.selectAll('circle').data(data).attr('cy', (height + 50) / 2).attr('cx', function (d) {
...
//# sourceMappingURL=/08-chart.add7c25c.map