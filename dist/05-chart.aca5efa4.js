...
(function () {
  ...
  var cxScale = d3.scaleLinear().domain([0, 10]).range([0, width]);
  ...
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('cy', height / 2).attr('cx', function (d) {
...
//# sourceMappingURL=/05-chart.aca5efa4.map