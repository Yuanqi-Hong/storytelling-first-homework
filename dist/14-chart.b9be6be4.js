...
module.exports = "/eating-data.099e0cef.csv";
...
(function () {
  ...
  var bandScale = d3.scaleBand().rangeRound([0, width]);
  var heightScale = d3.scaleLinear().domain([0, 10]).range([0, height]);
  var fillScale = d3.scaleOrdinal().range(['#FFB6C1', '#7FCDBB', '#2C7FB8']);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('rect').data(datapoints).enter().append('rect').attr('x', function (d) {
      return bandScale(d.name);
    }).attr('width', bandScale.bandwidth()).attr('height', function (d) {
...
//# sourceMappingURL=/14-chart.b9be6be4.map